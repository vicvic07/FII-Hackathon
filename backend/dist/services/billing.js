export function chargeProfessionalChat(input) {
    if (input.conversation.kind !== 'PROFESSIONAL')
        return { chargedCents: 0, billedSeconds: input.conversation.billedSeconds };
    ...
    if (chargeCents > input.payer.walletCents)
